...
for index, row in df.iterrows():
    ...
    LineNumber_orig = row["LineNumber_orig"]
    LineNumber_Prect = row["LineNumber_Prect"]
    SelfGivenName_Prect = row["SelfGivenName_Prect"]
    SelfSurname_Prect = row["SelfSurname_Prect"]
    codea_Prect = row["codea_Prect"]
    codeb_Prect = row["codeb_Prect"]
    selfresidencehoursworked_Prect = row["selfresidencehoursworked_Prect"]
    selfresidenceoccupation_Prect = row["selfresidenceoccupation_Prect"]
    selfresidenceindustry_Prect = row["selfresidenceindustry_Prect"]
    codecone_Prect = row["codecone_Prect"]
    codectwo_Prect = row["codectwo_Prect"]
    codecthree_Prect = row["codecthree_Prect"]
